...
.
├── skills/
│   └── too_many_grass.md     # Behavioral core — fed to the Agent
├── docs/
...
- **`skills/too_many_grass.md`** — the "Neural Overload Edition" skill definition. Drop this into your Agent's skill loader and it will activate "The Melt" when context or complexity gets out of hand.
...
1. Copy `skills/too_many_grass.md` into your agent framework's skills directory.
...
| Complexity   | Input > 5000 chars or spaghetti code detected| Force "Too Many Grass" mode     |
